    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className={`flex-grow relative overflow-hidden bg-gray-50 ${view === 'chat' ? 'p-0' : 'flex items-center justify-center p-4'}`}>
        ...
        {view === 'chat' && activeChatProfile && (
          <div   className="h-screen fixed inset-0 z-50 flex flex-col w-full bg-white sm:rounded-xl sm:shadow-2xl sm:relative sm:h-[calc(100vh-120px)] sm:max-w-md sm:mx-auto overflow-hidden">                    
            {/* Header */}
